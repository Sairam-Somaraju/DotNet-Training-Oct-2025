...
namespace Linq_Immediate_and_Deffered
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Employee{Id=1, Name="Sairam", Salary=30000},
                new Employee{Id=2, Name="Vennela", Salary=42000},
                new Employee{Id=3, Name="Prudhvi", Salary=54000},
            };
            ...
            emp.Add(new Employee { Id = 4, Name = "Rajesh", Salary = 28000 });
