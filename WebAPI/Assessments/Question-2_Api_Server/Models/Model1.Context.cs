...
namespace WebApplication2.Models
{
    ...
    public partial class NorthwindEntities1 : DbContext
    {
        ...
        [DbFunction("NorthwindEntities1", "fn_getCustomersByCountry")]
        public virtual IQueryable<fn_getCustomersByCountry_Result> fn_getCustomersByCountry(string country)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_getCustomersByCountry_Result>("[NorthwindEntities1].[fn_getCustomersByCountry](@country)", countryParameter);
        }
